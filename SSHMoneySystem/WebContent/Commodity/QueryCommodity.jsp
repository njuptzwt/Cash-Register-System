	...
	<s:form action="Commodity_CartCommodity" namespace="/Commodity"
		...
		<table  class="table table-striped table-border table-hover">
			...
			<!-- jsp中为了防止用户恶意篡改，用readonly只读，而且服务器端可以接收参数 -->
				<td align="center"><input type="text" name="cid" readonly style="border:0px" value="<s:property value='#session.commodity.cid'/>" /></td>
				<td align="center"><s:property value="#session.commodity.cname" /></td>
				<td align="center"><input id="price" readonly type="text"
				...
				<td align="center"><input name="totalprice" readonly id="totalprice" type="text"
					value='<s:property value="#session.commodity.price"/>'></td>
				<td align="center"><input type="submit" value="进账"></td>
				<!--  <td><img
